...
document.querySelector(".keybroad").onmousedown = function (e) {
  e.preventDefault();
};

document.querySelector(".clear").onmousedown = function (e) {
  e.preventDefault();
};
...
document.querySelectorAll(".all-option .title").forEach((element) => {
  element.onclick = () => {
    document.querySelectorAll(".all-option .title").forEach((tipp) => {
      tipp.classList.remove("active");
    });
